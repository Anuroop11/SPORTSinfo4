...
public class Badminton extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lscore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webView.loadUrl("https://www.flashscore.in/badminton/");
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.nav_home:
                Intent h= new Intent(Badminton.this,Home.class);
                startActivity(h);
                break;
            case R.id.nav_cricket:
                Intent c= new Intent(Badminton.this,Cricket.class);
                startActivity(c);
                break;
            case R.id.nav_football:
                Intent f= new Intent(Badminton.this,Football.class);
                startActivity(f);
                break;
            case R.id.nav_tennis:
                Intent t= new Intent(Badminton.this,Tennis.class);
                startActivity(t);
            case R.id.nav_badminton:
                Intent b= new Intent(Badminton.this,Badminton.class);
                startActivity(b);
                break;
